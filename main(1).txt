...
bot = Client("bot",
             bot_token= "7611901718:AAEusvOY57OodWl_WgwcEVm-RiY0MysGMFI", 
             #bot_token= os.environ.get("BOT_TOKEN"),
             api_id= 22544661,
             api_hash= "5dbcbc7c7388e8442f5da278b5914610)
auth_users = [6960427846]
#romeo  
            ...
            try:   
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002463068122)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
